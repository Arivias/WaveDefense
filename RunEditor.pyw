...
class App:
    ...
    def __init__(self):
        ...
        #icon
        icosurf=pygame.Surface((32,32))
        icon=vr.Rig("Resources/Vector_Rigs/Icon/vecrig.json")
        icon.x=16
        icon.y=16
        icon.render(icosurf)
        #icosurf.set_colorkey((0,0,0))
        ...
        pygame.display.set_caption('Unnamed - Vector Rig Editor')
